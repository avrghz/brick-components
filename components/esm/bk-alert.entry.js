import { r as registerInstance, c as createEvent, h, H as Host } from './index-c7d865b7.js';
...
const Alert = class {
    ...
    render() {
        return (h(Host, { role: "alert" }, h("div", { class: `bk-alert bk-alert--${this.variant} bk-alert--${this.shade} ${this.dismissible ? 'bk-alert--dismissible' : ''}` }, this.dismissible && (h("button", { class: "bk-button bk-button--text bk-alert__close-btn", onClick: this.onCloseHandler }, h("iron-icon", { icon: "close", class: "bk-icon" }))), h("slot", null))));
    }
};
Alert.style = indexCss;

export { Alert as bk_alert };
