...
const Modal = class {
    ...
    render() {
        ...
        return (h(Host, { role: "dialog", tabIndex: 0, "aria-modal": "true", "aria-hidden": this.open }, h("div", { class: "bk-modal" }, h("div", { role: "document", class: "bk-modal__content", ref: (el) => (this.modalRef = el) }, h("focus-trap", null, this.header && (h("header", { class: "bk-modal__header" }, h("span", { class: "bk-modal__title" }, this.header), this.dismissible && (h("button", { tabIndex: 0, "aria-label": "Close", class: "bk-button bk-button--text bk-modal__close-btn", onClick: this.onCloseHandler }, h("iron-icon", { icon: "close", class: "bk-icon" }))))), h("main", { class: "bk-modal__body" }, h("slot", { name: "body" })), this.hasFooter && (h("footer", { class: "bk-modal__footer" }, h("slot", { name: "footer" }))))), h("div", Object.assign({ ref: (el) => (this.backdropRef = el), class: "bk-modal__backdrop" }, (this.dismissible ? { onClick: this.onCloseHandler } : {}))))));
    }
    get el() { return getElement(this); }
};
Modal.style = indexCss;

export { Modal as bk_modal };
