...
const Switch = class {
    ...
    render() {
        return (h(Host, { role: "switch", "aria-label": "switch", "aria-readonly": this.disabled, "aria-checked": this.isOn, tabIndex: "0" }, h("div", { class: `bk-switch bk-switch--${this.variant}` }, h("input", { type: "checkbox", name: "chk", class: "bk-switch__input", checked: this.isOn, disabled: this.disabled, tabIndex: -1, "aria-hidden": "true" }), h("span", { class: "bk-switch__core" }))));
    }
};
Switch.style = indexCss;

export { Switch as bk_switch };
