...
const SetPopper = ({ reference, popper: popper$1, controllingProp }) => (target, property) => {
    let popperInstance;
    ...
    const initPopper = (component) => {
        if (component[popper$1] && component[reference] && component[controllingProp]) {
            popperInstance = popper.createPopper(component[reference], component[popper$1], {
