...
const Dropdown = class {
    constructor(hostRef) {
        ...
        this.bkMenuKeydown = index$1.createEvent(this, "bkMenuKeydown", 7);
    }
    componentDidLoad() {
        this.menuHandler();
    ...
    render() {
        return (index$1.h(index$1.Host, { role: "button", "aria-haspopup": "true", "aria-expanded": this.open, class: this.disabled ? 'bk-dropdown--disabled' : '' }, index$1.h("div", { class: "bk-dropdown" }, index$1.h("slot", { name: "control" }), this.open && (index$1.h("div", { class: "bk-dropdown-menu bk-popper", onClick: this.onMenuClick, ref: (el) => (this.popoverRef = el), tabIndex: -1 }, index$1.h("div", { class: "bk-dropdown-menu__inner", tabIndex: -1, ref: (el) => (this.menuRef = el) }, index$1.h("div", { class: "bk-popper__arrow", "data-popper-arrow": true }), index$1.h("slot", { name: "content" })))))));
    }
    get el() { return index$1.getElement(this); }
};
Dropdown.style = indexCss;

exports.bk_dropdown = Dropdown;
