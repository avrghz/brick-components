...
const Popover = class {
    ...
    render() {
        return (index.h(index.Host, { "aria-label": "popover", class: this.disabled ? 'bk-popover--disabled' : '' }, index.h("slot", { name: "control" }), this.show && !this.disabled && (index.h("div", { class: "bk-popover bk-popper", ref: (el) => (this.popoverRef = el), role: "tooltip" }, index.h("div", { class: "bk-popover__inner" }, index.h("div", { class: "bk-popper__arrow", "data-popper-arrow": true }), index.h("slot", { name: "content" }))))));
    }
