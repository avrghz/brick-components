...
const SetPopper = ({ reference, popper, controllingProp, modifiers = [], initialPlacement = 'auto', eventAfterOpened, eventAfterClosed, }) => (target, property) => {
    let popperInstance;
